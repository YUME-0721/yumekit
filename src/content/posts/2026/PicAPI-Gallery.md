...
| 参数        | 描述                             | 示例                                        |
| --------- | ------------------------------ | ----------------------------------------- |
| `?img=h`  | 获取一张随机的**横屏**图片 (PC壁纸)         | `http://xxx/pic` 或 `http://xxx/pic?img=h` |
| `?img=v`  | 获取一张随机的**竖屏**图片 (手机壁纸)         | `http://xxx/pic?img=v`                    |
| `?img=ua` | 根据访问设备自动返回适配图片 (手机返回竖屏，PC返回横屏) | `http://xxx/pic?img=ua`                   |
